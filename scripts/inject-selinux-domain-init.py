...
def fix_rules(kernel_root):
    ...
    new = (
        ...
        '    /* Allow untrusted_app to execmod on system_lib_file/system_linker_exec.\n'
        '     * Banking apps (ABC, etc.) use protection shells (SecNeo) that\n'
        '     * modify libc.so/linker64 in memory and require execmod.\n'
        '     * Without this, the protection shell fails to initialize and\n'
        '     * the app shows fake "network error". Verified via dmesg:\n'
        ...
        '     * This is a prerequisite for the protection shell to run,\n'
        '     * NOT a root detection vector. Affects all third-party apps\n'
        '     * that perform in-memory code patching. */\n'
        '    ksu_allow(db, "untrusted_app", "system_lib_file", "file", "execmod");\n'
        '    ksu_allow(db, "untrusted_app_30", "system_lib_file", "file", "execmod");\n'
        '    ksu_allow(db, "untrusted_app", "system_linker_exec", "file", "execmod");\n'
        '    ksu_allow(db, "untrusted_app_30", "system_linker_exec", "file", "execmod");\n'
        '    /* Allow reading proc/net for banking app H5 containers.\n'
        '     * UC WebView (used by Alipay/ABC) reads /proc/net/unix to\n'
        '     * check network socket state. Without this, the WebView\n'
        '     * fails and the app shows "network error". */\n'
        '    ksu_allow(db, "untrusted_app", "proc_net", "file", "read");\n'
        '    ksu_allow(db, "untrusted_app_30", "proc_net", "file", "read");\n'
        '    ksu_allow(db, "untrusted_app", "proc_net", "file", "open");\n'
        '    ksu_allow(db, "untrusted_app_30", "proc_net", "file", "open");\n'
        '    /* Allow system property access (userdebug_or_eng for build type check) */\n'
        '    ksu_allow(db, "untrusted_app", "userdebug_or_eng_prop", "file", "read");\n'
        '    ksu_allow(db, "untrusted_app_30", "userdebug_or_eng_prop", "file", "read");\n'
        '    ksu_allow(db, "untrusted_app", "userdebug_or_eng_prop", "file", "getattr");\n'
        '    ksu_allow(db, "untrusted_app_30", "userdebug_or_eng_prop", "file", "getattr");\n'
        '    ksu_allow(db, "untrusted_app", "userdebug_or_eng_prop", "file", "open");\n'
        '    ksu_allow(db, "untrusted_app_30", "userdebug_or_eng_prop", "file", "open");\n'
        '    ksu_allow(db, "untrusted_app", "userdebug_or_eng_prop", "file", "map");\n'
        '    ksu_allow(db, "untrusted_app_30", "userdebug_or_eng_prop", "file", "map");\n'
        '    /* Allow reading proc version and pid_max */\n'
        '    ksu_allow(db, "untrusted_app", "proc_version", "file", "read");\n'
        '    ksu_allow(db, "untrusted_app_30", "proc_version", "file", "read");\n'
        '    ksu_allow(db, "untrusted_app", "proc_version", "file", "open");\n'
        '    ksu_allow(db, "untrusted_app_30", "proc_version", "file", "open");\n'
        '    ksu_allow(db, "untrusted_app", "proc_version", "file", "getattr");\n'
        '    ksu_allow(db, "untrusted_app_30", "proc_version", "file", "getattr");\n'
        '    ksu_allow(db, "untrusted_app", "proc_pid_max", "file", "read");\n'
        '    ksu_allow(db, "untrusted_app_30", "proc_pid_max", "file", "read");\n'
        '    ksu_allow(db, "untrusted_app", "proc_pid_max", "file", "open");\n'
        '    ksu_allow(db, "untrusted_app_30", "proc_pid_max", "file", "open");\n'
        '    /* Allow zygote and all app domains to connect to the ReZygisk\n'
        '     * daemon socket (zygisk_file:s0). ReZygiskd chcons its control\n'
        '     * socket to zygisk_file and libzygisk (zygisk-core, injected\n'
        '     * into zygote) connects to it from both the zygote and the\n'
        '     * forked app domains. Under Enforcing SELinux without these\n'
        '     * rules the connect fails with EACCES ("Permission denied"):\n'
        '     *   zygisk-core64: Failed to connect to ReZygiskd ... 13\n'
        '     * which breaks the ZYGOTE64_INJECTED status report (WebUI shows\n'
        '     * "Not Working" even though injection succeeded) and breaks\n'
        '     * Zygisk module companion-socket communication. */\n'
        '    ksu_allow(db, "zygote", "zygisk_file", "sock_file", ALL);\n'
        '    ksu_allow(db, "appdomain", "zygisk_file", "sock_file", ALL);\n'
        '    /* ReZygisk daemon socket (cp64.sock) ends up with the\n'
        '     * "unlabeled" type at runtime: its sockcreate write is not\n'
        '     * honored (socket inode stays unlabeled despite chcon showing\n'
        '     * zygisk_file — chcon only relabels the visible xattr, the\n'
        '     * kernel checks the socket blob). Empirically confirmed via\n'
        '     * avc: denied { write } tcontext=u:object_r:unlabeled:s0\n'
        '     * tclass=sock_file scontext=u:r:zygote:s0. Cover that too. */\n'
        '    ksu_allow(db, "zygote", "unlabeled", "sock_file", ALL);\n'
        '    ksu_allow(db, "appdomain", "unlabeled", "sock_file", ALL);\n'
        '    /* Allow odsign property access (previously denied: map) */\n'
        '    ksu_allow(db, "untrusted_app", "odsign_prop", "file", "read");\n'
        '    ksu_allow(db, "untrusted_app_30", "odsign_prop", "file", "read");\n'
        '    ksu_allow(db, "untrusted_app", "odsign_prop", "file", "getattr");\n'
        '    ksu_allow(db, "untrusted_app_30", "odsign_prop", "file", "getattr");\n'
        '    ksu_allow(db, "untrusted_app", "odsign_prop", "file", "open");\n'
        '    ksu_allow(db, "untrusted_app_30", "odsign_prop", "file", "open");\n'
